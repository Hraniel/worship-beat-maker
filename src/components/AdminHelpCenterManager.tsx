...
import {
  Plus, Trash2, Loader2, ChevronDown, ChevronUp, Save, GripVertical,
  Pencil, Check, X, HelpCircle, BookOpen, MessageCircleQuestion,
...
const AdminHelpCenterManager: React.FC = () => {
  const [view, setView] = useState<'categories' | 'articles' | 'faqs'>('categories');
