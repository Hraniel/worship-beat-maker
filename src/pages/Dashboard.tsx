        ...
        <div className="mb-6">
          ...
          {subscriptionError && (
            <div className="mb-4 flex flex-col items-center justify-center gap-3 rounded-xl border border-destructive/30 bg-destructive/5 p-6 text-center">
              ...
              <p className="text-sm font-medium text-foreground">{t('dashboard.subscriptionErrorTitle', 'Não foi possível verificar sua assinatura')}</p>
              <p className="text-xs text-muted-foreground max-w-sm">{t('dashboard.subscriptionErrorDesc', 'A loja pode não exibir todos os recursos corretamente. Verifique sua conexão e tente novamente.')}</p>
              <button
