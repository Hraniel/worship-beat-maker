    ...
    >
      ...
      {!focusMode ? (
        !currentSongId ? (
          ...
          <header className="relative z-[50] overflow-visible flex items-center justify-between px-4 py-3 bg-primary/10 border-b border-primary/20 shrink-0 min-h-[48px]">
