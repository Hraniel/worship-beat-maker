...
const Index = () => {
  ...
  return (
    <div className="flex flex-col bg-background overflow-hidden" style={{ height: '100%', paddingTop: 'env(safe-area-inset-top, 0px)', paddingLeft: 'env(safe-area-inset-left, 0px)', paddingRight: 'env(safe-area-inset-right, 0px)', boxSizing: 'border-box' }} onPointerDown={initAudio}>
